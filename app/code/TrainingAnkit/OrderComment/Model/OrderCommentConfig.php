...
class OrderCommentConfig implements ConfigProviderInterface
{
     ...
     *  Config Paths
     */
    const XML_PATH_GENERAL_IS_SHOW_IN_MYACCOUNT = 'trainingankit_ordercomment/general/is_show_in_myaccount';
    const XML_PATH_GENERAL_MAX_LENGTH = 'trainingankit_ordercomment/general/max_length';
    const XML_PATH_GENERAL_FIELD_STATE = 'trainingankit_ordercomment/general/state';
    ...
    public function getConfig()
    {
        return [
            ...
            'ta_order_comment_default_state' => (int) $this->scopeConfig->getValue(
