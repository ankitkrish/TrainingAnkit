...
return [
    'modules' => [
        ...
        'Klarna_Kp' => 1,
        'MagentoCoders_BannerSlider' => 0,
        'MagentoCoders_Blog' => 0,
        'MagentoCoders_Catalog' => 0,
        'MagentoCoders_GraphQl' => 0,
        'PayPal_Braintree' => 1,
        'PayPal_BraintreeGraphQl' => 1,
        'Rsgitech_News' => 0,
        'Temando_ShippingRemover' => 1,
        'TrainingAnkit_CustomerAccount' => 0,
        'TrainingAnkit_Productapi' => 1,
        'Vertex_Tax' => 1,
